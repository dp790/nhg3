...
// SETTINGS PAGE
// ══════════════════════════════════════════════════════════
function SettingsPage({onStart,onBrowse}){
    ...
    <div style={{maxWidth:560,width:"100%",margin:"0 auto",paddingTop:32}}>
      <div style={{textAlign:"center",marginBottom:28,position:"relative"}}>
        ...
        <button onClick={()=>onBrowse()} style={{
          ...
          padding:"8px 14px",fontSize:12,color:C.textMid,cursor:"pointer",
...
export default function App(){
  const [screen,setScreen]=useState("home"); // home | preview | quiz | summary | browse
  ...
  return(
    <div style={{minHeight:"100vh",background:C.pageBg}}>
      ...
      <div style={{animation:"fadeIn .35s ease"}}>
        {screen==="home"&&<div style={{padding:"0 16px 48px"}}><SettingsPage onStart={handleStart} onBrowse={()=>setScreen("browse")}/></div>}

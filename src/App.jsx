...
const KANJI_WORDS = [
  {id:"kw0",word:"日",read:"ひ",tr:"the sun",lesson:1},
  {id:"kw1",word:"日曜日",read:"にちようび",tr:"Sunday",lesson:1},
  {id:"kw2",word:"日本",read:"にほん",tr:"Japan",lesson:1},
  {id:"kw3",word:"月",read:"つき",tr:"the moon",lesson:1},
  {id:"kw4",word:"月曜日",read:"げつようび",tr:"Monday",lesson:1},
  {id:"kw5",word:"木曜日",read:"もくようび",tr:"Thursday",lesson:1},
  {id:"kw6",word:"山",read:"やま",tr:"a mountain",lesson:1},
  {id:"kw7",word:"富士山",read:"ふじさん",tr:"Mt. Fuji",lesson:1},
  {id:"kw8",word:"火山",read:"かざん",tr:"a volcano",lesson:1},
  {id:"kw9",word:"川",read:"かわ",tr:"a river",lesson:1},
  {id:"kw10",word:"小川",read:"おがわ",tr:"a brook",lesson:1},
  {id:"kw11",word:"水田",read:"すいでん",tr:"a rice field",lesson:1},
  {id:"kw12",word:"日本人",read:"にほんじん",tr:"a Japanese person",lesson:1},
  {id:"kw13",word:"入口",read:"いりぐち",tr:"an entrance",lesson:1},
  {id:"kw14",word:"出口",read:"でぐち",tr:"an exit",lesson:1},
  {id:"kw15",word:"人口",read:"じんこう",tr:"population",lesson:1},
  {id:"kw16",word:"電車",read:"でんしゃ",tr:"a train",lesson:1},
  {id:"kw17",word:"自動車",read:"じどうしゃ",tr:"an automobile",lesson:1},
  {id:"kw18",word:"専門",read:"せんもん",tr:"a specialty",lesson:1},
  {id:"kw19",word:"火曜日",read:"かようび",tr:"Tuesday",lesson:2},
  {id:"kw20",word:"火事",read:"かじ",tr:"a fire (incident)",lesson:2},
  {id:"kw21",word:"水曜日",read:"すいようび",tr:"Wednesday",lesson:2},
  {id:"kw22",word:"お金",read:"おかね",tr:"money",lesson:2},
  {id:"kw23",word:"金曜日",read:"きんようび",tr:"Friday",lesson:2},
  {id:"kw24",word:"土曜日",read:"どようび",tr:"Saturday",lesson:2},
  {id:"kw25",word:"女子学生",read:"じょしがくせい",tr:"a girl student",lesson:2},
  {id:"kw26",word:"彼女",read:"かのじょ",tr:"she / girlfriend",lesson:2},
  {id:"kw27",word:"学生",read:"がくせい",tr:"a student",lesson:2},
  {id:"kw28",word:"大学",read:"だいがく",tr:"a university",lesson:2},
  {id:"kw29",word:"学校",read:"がっこう",tr:"a school",lesson:2},
  {id:"kw30",word:"先生",read:"せんせい",tr:"a teacher",lesson:2},
  {id:"kw31",word:"先月",read:"せんげつ",tr:"last month",lesson:2},
  {id:"kw32",word:"私立大学",read:"しりつだいがく",tr:"a private university",lesson:2},
  {id:"kw33",word:"一月",read:"いちがつ",tr:"January",lesson:3},
  {id:"kw34",word:"一人",read:"ひとり",tr:"one person",lesson:3},
  {id:"kw35",word:"二月",read:"にがつ",tr:"February",lesson:3},
  {id:"kw36",word:"二人",read:"ふたり",tr:"two people",lesson:3},
  {id:"kw37",word:"三月",read:"さんがつ",tr:"March",lesson:3},
  {id:"kw38",word:"四月",read:"しがつ",tr:"April",lesson:3},
  {id:"kw39",word:"四日",read:"よっか",tr:"the 4th day",lesson:3},
  {id:"kw40",word:"五月",read:"ごがつ",tr:"May",lesson:3},
  {id:"kw41",word:"六月",read:"ろくがつ",tr:"June",lesson:3},
  {id:"kw42",word:"七月",read:"しちがつ",tr:"July",lesson:3},
  {id:"kw43",word:"七日",read:"なのか",tr:"the 7th day",lesson:3},
  {id:"kw44",word:"八月",read:"はちがつ",tr:"August",lesson:3},
  {id:"kw45",word:"八日",read:"ようか",tr:"the 8th day",lesson:3},
  {id:"kw46",word:"九月",read:"くがつ",tr:"September",lesson:3},
  {id:"kw47",word:"十月",read:"じゅうがつ",tr:"October",lesson:3},
  {id:"kw48",word:"十日",read:"とおか",tr:"the 10th day",lesson:3},
  {id:"kw49",word:"千円",read:"せんえん",tr:"a thousand yen",lesson:3},
  {id:"kw50",word:"一万円",read:"いちまんえん",tr:"ten thousand yen",lesson:3},
  {id:"kw51",word:"百円",read:"ひゃくえん",tr:"100 yen",lesson:3},
  {id:"kw52",word:"去年",read:"きょねん",tr:"last year",lesson:3},
  {id:"kw53",word:"来年",read:"らいねん",tr:"next year",lesson:3},
  {id:"kw54",word:"地下",read:"ちか",tr:"underground",lesson:4},
  {id:"kw55",word:"中学校",read:"ちゅうがっこう",tr:"junior high school",lesson:4},
  {id:"kw56",word:"大人",read:"おとな",tr:"an adult",lesson:4},
  {id:"kw57",word:"小学校",read:"しょうがっこう",tr:"primary school",lesson:4},
  {id:"kw58",word:"本日",read:"ほんじつ",tr:"today (formal)",lesson:4},
  {id:"kw59",word:"半年",read:"はんとし",tr:"half a year",lesson:4},
  {id:"kw60",word:"半分",read:"はんぶん",tr:"half",lesson:4},
  {id:"kw61",word:"五分",read:"ごふん",tr:"five minutes",lesson:4},
  {id:"kw62",word:"水力",read:"すいりょく",tr:"water power",lesson:4},
  {id:"kw63",word:"何人",read:"なんにん",tr:"how many people",lesson:4},
  {id:"kw64",word:"明日",read:"あした",tr:"tomorrow",lesson:5},
  {id:"kw65",word:"休日",read:"きゅうじつ",tr:"a holiday",lesson:5},
  {id:"kw66",word:"体力",read:"たいりょく",tr:"physical strength",lesson:5},
  {id:"kw67",word:"好物",read:"こうぶつ",tr:"one's favorite food",lesson:5},
  {id:"kw68",word:"男子学生",read:"だんしがくせい",tr:"a boy student",lesson:5},
  {id:"kw69",word:"長男",read:"ちょうなん",tr:"eldest son",lesson:5},
  {id:"kw70",word:"森林",read:"しんりん",tr:"woods and forests",lesson:5},
  {id:"kw71",word:"時間",read:"じかん",tr:"time",lesson:5},
  {id:"kw72",word:"一年間",read:"いちねんかん",tr:"one year (duration)",lesson:5},
  {id:"kw73",word:"花畑",read:"はなばたけ",tr:"a flower garden",lesson:5},
  {id:"kw74",word:"目次",read:"もくじ",tr:"table of contents",lesson:6},
  {id:"kw75",word:"手紙",read:"てがみ",tr:"a letter",lesson:6},
  {id:"kw76",word:"歌手",read:"かしゅ",tr:"a singer",lesson:6},
  {id:"kw77",word:"大雨",read:"おおあめ",tr:"heavy rain",lesson:6},
  {id:"kw78",word:"米国",read:"べいこく",tr:"U.S.A.",lesson:6},
  {id:"kw79",word:"石油",read:"せきゆ",tr:"petroleum",lesson:6},
  {id:"kw80",word:"毛糸",read:"けいと",tr:"woollen yarn",lesson:6},
  {id:"kw81",word:"花火",read:"はなび",tr:"fireworks",lesson:7},
  {id:"kw82",word:"紅茶",read:"こうちゃ",tr:"black tea",lesson:7},
  {id:"kw83",word:"喫茶店",read:"きっさてん",tr:"a coffee shop",lesson:7},
  {id:"kw84",word:"牛肉",read:"ぎゅうにく",tr:"beef",lesson:7},
  {id:"kw85",word:"鳥肉",read:"とりにく",tr:"chicken (meat)",lesson:7},
  {id:"kw86",word:"文学",read:"ぶんがく",tr:"literature",lesson:7},
  {id:"kw87",word:"漢字",read:"かんじ",tr:"Kanji characters",lesson:7},
  {id:"kw88",word:"数字",read:"すうじ",tr:"a number / digit",lesson:7},
  {id:"kw89",word:"買物",read:"かいもの",tr:"shopping",lesson:7},
  {id:"kw90",word:"荷物",read:"にもつ",tr:"baggage",lesson:7},
  {id:"kw91",word:"牛乳",read:"ぎゅうにゅう",tr:"cow's milk",lesson:7},
  {id:"kw92",word:"馬車",read:"ばしゃ",tr:"a carriage",lesson:7},
  {id:"kw93",word:"白鳥",read:"はくちょう",tr:"a swan",lesson:7},
  {id:"kw94",word:"金魚",read:"きんぎょ",tr:"a goldfish",lesson:7},
  {id:"kw95",word:"新車",read:"しんしゃ",tr:"a new car",lesson:8},
  {id:"kw96",word:"新聞",read:"しんぶん",tr:"a newspaper",lesson:8},
  {id:"kw97",word:"新年",read:"しんねん",tr:"New Year",lesson:8},
  {id:"kw98",word:"古本",read:"ふるほん",tr:"a used book",lesson:8},
  {id:"kw99",word:"高校",read:"こうこう",tr:"a high school",lesson:8},
  {id:"kw100",word:"高速",read:"こうそく",tr:"high speed",lesson:8},
  {id:"kw101",word:"短大",read:"たんだい",tr:"a junior college",lesson:8},
  {id:"kw102",word:"低温",read:"ていおん",tr:"low temperature",lesson:8},
  {id:"kw103",word:"暗室",read:"あんしつ",tr:"a dark room",lesson:8},
  {id:"kw104",word:"多数",read:"たすう",tr:"a large number",lesson:8},
  {id:"kw105",word:"少年",read:"しょうねん",tr:"a boy",lesson:8},
  {id:"kw106",word:"少女",read:"しょうじょ",tr:"a girl",lesson:8},
  {id:"kw107",word:"来月",read:"らいげつ",tr:"next month",lesson:9},
  {id:"kw108",word:"食事",read:"しょくじ",tr:"a meal",lesson:9},
  {id:"kw109",word:"夕食",read:"ゆうしょく",tr:"dinner / supper",lesson:9},
  {id:"kw110",word:"意見",read:"いけん",tr:"an opinion",lesson:9},
  {id:"kw111",word:"読書",read:"どくしょ",tr:"reading books",lesson:9},
  {id:"kw112",word:"書店",read:"しょてん",tr:"a bookstore",lesson:9},
  {id:"kw113",word:"書道",read:"しょどう",tr:"calligraphy",lesson:9},
  {id:"kw114",word:"会話",read:"かいわ",tr:"conversation",lesson:9},
  {id:"kw115",word:"電話",read:"でんわ",tr:"a telephone",lesson:9},
  {id:"kw116",word:"教室",read:"きょうしつ",tr:"a classroom",lesson:9},
  {id:"kw117",word:"朝食",read:"ちょうしょく",tr:"breakfast",lesson:10},
  {id:"kw118",word:"朝日",read:"あさひ",tr:"the morning sun",lesson:10},
  {id:"kw119",word:"昼食",read:"ちゅうしょく",tr:"lunch",lesson:10},
  {id:"kw120",word:"夜中",read:"よなか",tr:"midnight",lesson:10},
  {id:"kw121",word:"今夜",read:"こんや",tr:"tonight",lesson:10},
  {id:"kw122",word:"今晩",read:"こんばん",tr:"tonight (this evening)",lesson:10},
  {id:"kw123",word:"晩御飯",read:"ばんごはん",tr:"dinner / supper",lesson:10},
  {id:"kw124",word:"夕方",read:"ゆうがた",tr:"evening",lesson:10},
  {id:"kw125",word:"午前",read:"ごぜん",tr:"morning / a.m.",lesson:10},
  {id:"kw126",word:"午後",read:"ごご",tr:"afternoon / p.m.",lesson:10},
  {id:"kw127",word:"正午",read:"しょうご",tr:"high noon",lesson:10},
  {id:"kw128",word:"前半",read:"ぜんはん",tr:"the first half",lesson:10},
  {id:"kw129",word:"後半",read:"こうはん",tr:"the last half",lesson:10},
  {id:"kw130",word:"毎日",read:"まいにち",tr:"every day",lesson:10},
  {id:"kw131",word:"毎週",read:"まいしゅう",tr:"every week",lesson:10},
  {id:"kw132",word:"毎月",read:"まいつき",tr:"every month",lesson:10},
  {id:"kw133",word:"来週",read:"らいしゅう",tr:"next week",lesson:10},
  {id:"kw134",word:"先週",read:"せんしゅう",tr:"last week",lesson:10},
  {id:"kw135",word:"週末",read:"しゅうまつ",tr:"the weekend",lesson:10},
  {id:"kw136",word:"一週間",read:"いっしゅうかん",tr:"one week",lesson:10},
];
...
function quickMatch(user, ans, isKun=false) {
  ...
  return ans.split("/").some(v => normStr(v) === u);
}
